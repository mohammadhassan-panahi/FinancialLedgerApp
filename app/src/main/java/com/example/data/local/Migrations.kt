...
val MIGRATION_19_20 = object : Migration(19, 20) {
    override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("ALTER TABLE `mutual_funds` ADD COLUMN `fundType` TEXT NOT NULL DEFAULT 'ETF'")
        db.execSQL("ALTER TABLE `mutual_funds` ADD COLUMN `inceptionDate` TEXT NOT NULL DEFAULT ''")
        db.execSQL("ALTER TABLE `mutual_funds` ADD COLUMN `totalAssetsToman` REAL NOT NULL DEFAULT 0.0")
    }
}
