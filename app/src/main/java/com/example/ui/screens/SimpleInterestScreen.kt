            ...
            Surface(
                ...
                Row(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                        ...
                        Column {
                            Text("سود ساده", style = DaraTypography.titleMedium, color = Slate50, fontWeight = FontWeight.Bold)
                            Text("محاسبات بانکی مستقیم", style = DaraTypography.labelSmall, color = IndigoElectric)
                        }
                    }
                }
            }
